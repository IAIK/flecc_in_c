...
IF( LCOV_COMMAND AND GENHTML_COMMAND AND (CMAKE_COMPILER_IS_GNUCC OR MINGW) )
  ...
  ADD_CUSTOM_TARGET(covGenerate
                            COMMAND "${CMAKE_COMMAND}" -E remove "${COVERAGE_DIR}/base.info"
                            COMMAND "${CMAKE_COMMAND}" -E remove "${COVERAGE_DIR}/coverage.info"
                            COMMAND "${CMAKE_COMMAND}" -E remove "${COVERAGE_DIR}/${CMAKE_PROJECT_NAME}.info"
                            ...
                            COMMAND "${CMAKE_COMMAND}" -E chdir "${COVERAGE_OUTPUT_DIR}" "${GENHTML_COMMAND}"  "${CMAKE_PROJECT_NAME}.info"
                            WORKING_DIRECTORY "${PROJECT_BINARY_DIR}"
